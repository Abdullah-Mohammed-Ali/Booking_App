import 'package:booking_app/features/home_nav/presentation/screens/welcomePage.dart';
...
class AppRoute {
  static Route? onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutingNames.homeNavScreen:
        return _fadeInRoute(page: const SecondPage());
  ...
  static PageRouteBuilder _fadeInRoute({page, durationInMillisec = 0}) {
