...
class _HotelsPageState extends State<HotelsPage> {
  ...
  Text _buildRatingStars(double rating) {
    ...
    stars.trim();
    return Text(stars , style: TextStyle(fontSize: 8),);
  }
                  ...
                  flexibleSpace: Stack(
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.only(bottomRight:Radius.circular(0) , bottomLeft: Radius.circular(30)),
                          child:  Image.asset(
                            'assets/img/6.jpg',
                            fit: BoxFit.cover,
                          ),
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                fillColor: AppColors.darkGrey, filled: true,
                                border: OutlineInputBorder(


                                  borderSide:  BorderSide(color: AppColors.darkGrey, width: 33.0),
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                    builder: (context) => BookNow(
                                      image: "http://api.mahmoudtaha.com/images/${state.hotels.data?.data2?[index].hotelImages?[0].image}" ,

                                      adress:  state.hotels.data?.data2?[index].address ??"Roma fgfgm gfn" ,
                                      name:  state.hotels.data?.data2?[index].name ?? "Grand Royal Hotel",

                                      price:  state.hotels.data?.data2?[index].price ??"Grand Royal" ,
                                      facilities:

                                      state.hotels.data?.data2?[index].hotelFacilities?[0].facilityId ??"Grand Royal",

                                      hoteId:state.hotels.data?.data2?[index].id ,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(
                                                ...
                                                state.hotels.data?.data2?[index].name !="Roma fgfgm gfn"
                                                    && state.hotels.data?.data2?[index].name !="Nasr Ciry Price 5000"
                                                ...
                                                Text(
                                                  ...
                                                  state.hotels.data?.data2?[index].name ?? "Grand Royal Hotel",                                          style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 12.0,
                                        ...
                                        Text(
                                          state.hotels.data?.data2?[index].address ??"Roma fgfgm gfn"
                                          ,
                                          style: TextStyle(
                                            fontSize: 7,
                                            color: Colors.grey,
                                          ...
                                          children:  <Widget>[
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Row(children: [
                                                  Icon(Icons.wrong_location_rounded , size: 13,
                                                    color: Colors.grey,
                                                  ),
                                                  Text(" ${index+3} km to city" ,style: TextStyle(fontSize: 9,
                                                    color: Colors.grey,
                                                  ),)
                                                ...
                                                Row(
                                                  children: [
                                                    Text("\$" , style: TextStyle(color: Colors.teal , fontWeight: FontWeight.bold , fontSize: 15),), // <-- Text

                                                    Text(state.hotels.data?.data2?[index].price ??"Grand Royal" ,
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            state.hotels.data?.data2?[index].rate =="10.50"?
                                            _buildRatingStars(5):
                                            _buildRatingStars(4),
                                        ...
                                        Text("${state.hotels.data?.data2?[index].rate ??"Grand Hotel"} out from 5 stars",
